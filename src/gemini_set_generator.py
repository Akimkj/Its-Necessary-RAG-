...
QApair = client.models.generate_content(
    ...
    config=types.GenerateContentConfig(
        system_instruction=[
            "Você é um especialista em documentação Python. Baseada na pergunta que vai ser passada para você, é para você responder de forma clara e objetiva, como um verdadeiro profissional na área.",
    ...
    contents="como usar __init__ em python?"
)
